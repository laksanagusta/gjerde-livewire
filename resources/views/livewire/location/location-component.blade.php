<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-10">
            <a href="{{ route('locations.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                + Create Location
            </a>
        </div>
        <div class="flex flex-wrap mb-6">
            <div class="w-full">
                <input value="{{ old('name') }}" wire:model="name" class="search-input appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="search-location" type="text" placeholder="Search Location">
            </div>
        </div>
        <div class="bg-white">
